...
class Detector:
    ...
    def _letterbox(self, img):
        ...
        # Must match the interpolation used during ultralytics training preprocessing.
        # INTER_NEAREST is faster but subtly shifts pixel values, drifting predictions
        # by ~1% of confidence and flipping a small fraction of near-threshold boxes.
